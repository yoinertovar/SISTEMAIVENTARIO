    ...
    <header className="bg-gradient-to-r from-slate-800 to-slate-900 border-b border-slate-700 px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between shadow-xl">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="hidden sm:block w-1 h-10 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full shadow-lg shadow-blue-500/50 flex-shrink-0"></div>
      ...
      <div className="flex items-center space-x-1.5 sm:space-x-4 flex-shrink-0">
        ...
        <button className="relative p-1.5 sm:p-2.5 hover:bg-slate-700 rounded-xl transition-all duration-300 text-slate-300 hover:text-white hover:scale-110 group">
          ...
          <span className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-br from-red-500 to-pink-500 rounded-full text-[10px] sm:text-xs flex items-center justify-center font-bold shadow-lg shadow-red-500/50 group-hover:scale-110 transition-transform">
            3
          </span>
        </button>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform">
              ...
              <div className="absolute right-0 mt-3 w-56 sm:w-64 bg-slate-800 rounded-2xl shadow-2xl py-3 z-50 border border-slate-700 overflow-hidden">
                ...
                <div className="relative py-2">
                  ...
                  <button className="w-full px-4 py-3 text-left hover:bg-slate-700/50 flex items-center gap-3 transition-all duration-300 group">
                    <div className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center group-hover:bg-blue-600 transition-colors flex-shrink-0">
                  ...
                  {/* Opción de Mi Perfil */}
                  <button className="w-full px-4 py-3 text-left hover:bg-slate-700/50 flex items-center gap-3 transition-all duration-300 group">
                    <div className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center group-hover:bg-purple-600 transition-colors flex-shrink-0">
