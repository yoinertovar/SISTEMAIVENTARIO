 ...
 * 
 * @example
 * <WorkerHeader setIsMobileOpen={setMobileOpen} />
 */
    ...
    <header className="bg-gradient-to-r from-slate-800 to-slate-900 border-b border-slate-700 px-6 py-4 flex items-center justify-between shadow-xl">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block w-1 h-10 bg-gradient-to-b from-emerald-500 to-teal-500 rounded-full shadow-lg shadow-emerald-500/50"></div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="relative p-2.5 hover:bg-slate-700 rounded-xl transition-all duration-300 text-slate-300 hover:text-white hover:scale-110 group">
          ...
          <span className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full text-xs flex items-center justify-center font-bold shadow-lg shadow-emerald-500/50 group-hover:scale-110 transition-transform">
            2
          </span>
        </button>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform">
              <User size={20} />
            </div>
              ...
              <div className="absolute right-0 mt-3 w-64 bg-slate-800 rounded-2xl shadow-2xl py-3 z-50 border border-slate-700 overflow-hidden">
                ...
                <div className="relative px-4 py-4 border-b border-slate-700 bg-gradient-to-r from-slate-700/50 to-slate-800/50">
                  <div className="flex items-center gap-3">
                    ...
                    {/* Datos del usuario */}
                    <div>
                      <p className="text-sm font-bold text-white">{user?.name || 'Trabajador'}</p>
                      <p className="text-xs text-slate-400">{user?.email || 'worker@example.com'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative py-2">
                  ...
                  <button className="w-full px-4 py-3 text-left hover:bg-slate-700/50 flex items-center gap-3 transition-all duration-300 group">
                    <div className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center group-hover:bg-emerald-600 transition-colors">
                  ...
                  <button className="w-full px-4 py-3 text-left hover:bg-slate-700/50 flex items-center gap-3 transition-all duration-300 group">
                    <div className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center group-hover:bg-teal-600 transition-colors">
