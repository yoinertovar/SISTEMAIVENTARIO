...
import { CreditCard, User, Edit2, Trash2 } from "lucide-react";

/**
 * Componente de tabla para mostrar registros de créditos
 * Proporciona visualización de datos con acciones de edición y eliminación
 * 
 * @componente
 ...
 */
const CreditsTable = ({ credits, onEdit, onDelete }) => {
        ...
        <table className="w-full">
          ...
          <thead className="bg-slate-700/50 border-b border-slate-600">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-bold text-slate-300 uppercase tracking-wider">Monto</th>
